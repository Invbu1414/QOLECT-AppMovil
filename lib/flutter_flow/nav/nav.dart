...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: OnBoarding1PageWidget.routeName,
          path: OnBoarding1PageWidget.routePath,
          builder: (context, params) => OnBoarding1PageWidget(),
        ),
        FFRoute(
          name: OnBoarding2PageWidget.routeName,
          path: OnBoarding2PageWidget.routePath,
          builder: (context, params) => OnBoarding2PageWidget(),
        ),
        FFRoute(
          name: OnBoarding3PageWidget.routeName,
          path: OnBoarding3PageWidget.routePath,
          builder: (context, params) => OnBoarding3PageWidget(),
        ),
        FFRoute(
          name: OnBoarding4PageWidget.routeName,
          path: OnBoarding4PageWidget.routePath,
          builder: (context, params) => OnBoarding4PageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: NoticesPageWidget.routeName,
          path: NoticesPageWidget.routePath,
          builder: (context, params) => NoticesPageWidget(),
        ),
        FFRoute(
          name: ViajePageWidget.routeName,
          path: ViajePageWidget.routePath,
          builder: (context, params) => ViajePageWidget(
        ...
        FFRoute(
          name: RestablecePageWidget.routeName,
          path: RestablecePageWidget.routePath,
          builder: (context, params) => RestablecePageWidget(),
        ),
        FFRoute(
          name: RegistrarPageWidget.routeName,
          path: RegistrarPageWidget.routePath,
        ...
        FFRoute(
          name: Comunidadv1Widget.routeName,
